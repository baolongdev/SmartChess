# SmartChess — Documentation Index

| # | File | Description |
|---|------|-------------|
| 1 | [01-overview.md](01-overview.md) | System goals and capabilities |
| 2 | [02-hardware-and-build.md](02-hardware-and-build.md) | Hardware wiring, PlatformIO setup, directory layout |
| 3 | [03-firmware-workflow.md](03-firmware-workflow.md) | Game lifecycle, START/STOP flow, command reference |
| 4 | [04-scan-state-machine.md](04-scan-state-machine.md) | RFID scan state machine — states and transitions |
| 5 | [05-ble-protocol.md](05-ble-protocol.md) | BLE GATT service, characteristics, ACK format |
